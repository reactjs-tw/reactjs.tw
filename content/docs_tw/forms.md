...
id: forms
title: 表單
permalink: tw/docs/forms.html
prev: lists-and-keys.html
next: lifting-state-up.html
redirect_from:
  - "tw/tips/controlled-input-null-value.html"
  - "tw/docs/forms-zh-CN.html"
---

HTML form elements work a little bit differently from other DOM elements in React, because form elements naturally keep some internal state. For example, this form in plain HTML accepts a single name:

在React中, HTML表單元件和一般的DOM元件運作起來有點不同, 這是因為表單元件本來就會存在有自己的state. 舉例來說: 
...
上面這個表單使用了預設的HTML表單行為: 當使用者送出一個表單之後, 自動跳轉到頁面. 然而一般來說, 我們希望的是有一個Javascript function 可以取得使用者填入的資料, 加以處理之後再送出. 要實作這個功能的標準方式我們稱之為"controlled components".
